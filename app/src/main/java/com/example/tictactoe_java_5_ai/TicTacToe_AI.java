...
public class TicTacToe_AI extends AppCompatActivity implements View.OnClickListener {
...
// Game is finished !
    ...
    private void finishGame() {
        ...
        final TicTacToe_AI ticTacToe_AI = this;

        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                // Do something after 5s = 5000ms
                Intent intent = new Intent (ticTacToe_AI, MainActivity.class);
